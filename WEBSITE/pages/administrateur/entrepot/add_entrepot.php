...
<html class="h-100">
    ...
    <?=navbar(10, "..")?>
        <div class="bg-secondary h-100 col-10 d-flex flex-column p-3">
            ...
            <h2 class="text-center p-5">Ajouter Un Entrepot</h2>
            ...
            <button class="btn btn-outline-primary my-5" onclick="create()">Créer un Entrepot</button>
        </div>
    </body>
    <script>
        function create(){
            ...
            postToApi('/entrepot/create', data, getCookie('ATD-TOKEN')).then(response => {
                response.json().then((json) => {
                    alert(json.msg);
                    location.href='entrepot.php';
                })
            });
        }
    </script>
