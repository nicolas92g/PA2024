...
<html class="h-100">
    ...
    <?=navbar(8, "..")?>
        <div class="bg-secondary h-100 col-10 d-flex flex-column p-3">
            ...
            <h2 class="text-center p-5">Ajouter Une Annexe</h2>
            ...
            <button class="btn btn-outline-primary my-5" onclick="create()">Créer Une Annexe</button>
        </div>
    </body>
    <script>
        function create(){
            ...
            postToApi('/annexe/create', data, getCookie('ATD-TOKEN')).then(response => {
